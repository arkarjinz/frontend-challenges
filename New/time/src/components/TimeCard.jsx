...
function TimeCard({time, image, cardTitle, subTime, bgColor}) {
    return (
        <>
            <div className={`${bgColor} relative w-full md:max-w-[300px] min-h-[170px] md:min-h-[250px]  rounded-xl overflow-hidden`}>
                <img src={image} alt="icon" className="absolute right-4"/>
             <div className="bg-Navy-900 absolute w-full min-h-[70%] md:min-h-[80%] bottom-0  rounded-t-xl p-7 flex flex-wrap flex-col justify-between">
